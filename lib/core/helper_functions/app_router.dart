import 'package:alwadi_food/feature/auth/presentaion/signin/views/signin_view.dart';
import 'package:alwadi_food/feature/auth/presentaion/signup/views/signup_view.dart';
import 'package:alwadi_food/feature/home/home_view.dart';
import 'package:alwadi_food/feature/on_boarding/presentaion/views/widgets/on_boarding_view_body.dart';
import 'package:alwadi_food/feature/splash/presentaion/views/splash_view.dart';
...
abstract class AppRouter {
  ...
  static final router = GoRouter(
    ...
    routes: [
      ...
      GoRoute(
        path: kOnboarding,
        builder: (context, state) => OnBoardingViewBody(),
      ),
