...
import 'package:alwadi_food/presentation/manager/presentation/views/widgets/manager_main/manager_main_view_body.dart';
...
class ManagerMainView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (_) => getIt<ManagerNavCubit>(),
      child: const ManagerMainViewBody(),
    );
  }
}
